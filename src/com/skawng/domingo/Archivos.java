...
public class Archivos {
    ...
    public void guardarInformacionEnArchivo(String informacion) throws IOException {
        File file = new File("quierodormir.txt");
        ...
        System.out.println("La información se ha guardado en el archivo 'quierodormir.txt' correctamente.");
    }
